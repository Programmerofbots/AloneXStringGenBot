...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Princes_log_support_group"))
        else:
            ...
            await client.join_chat("@Princes_log_support_group")
    except KeyError:
        pass
    try:
